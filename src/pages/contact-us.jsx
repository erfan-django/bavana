    ...
    return (
        <div>
            <div className="hidden lg:flex relative  justify-center items-center ">
                ...
                <div className="absolute bottom-0 w-[1272px]  bg-white rounded-[50px] p-6 flex items-center flex-col justify-center">
                    <div className="flex items-center justify-between w-full mx-[120px]">
                        <div className="mr-[80px]">
                            <h2 className="text-3xl font-bold text-[#8D5215] dark:text-[#DF7F1D]">تماس با باوانا</h2>
                            <p className="text-lg text-gray-600 dark:text-gray-300">از این راه با ما در ارتباط باشید</p>
                        </div>
            ...
            <div className="lg:mr-12 mt-[60px] flex flex-col items-center lg:flex-row lg:justify-between">
                <div className="max-sm:flex max-sm:flex-col">
                    <h3 className="text-[#8D5215] text-2xl lg:text-3xl">ارسال پیام به ما</h3>
                    <p className="mt-3 text-xl lg:text-2xl">پذیرای پیشنهادات و انتقادات شما هستیم</p>
                    <form className="flex flex-col items-center gap-5">
                        <input type="text" placeholder="نام شما" className="pr-7 px-3 py-8 text-xl xl:text-2xl max-h-[25px] w-[261px] md:w-[180px] xl:w-[449px] placeholder-[#8D521580]/60 dark:placeholder-[#8D5215] border-2 border-[#ED8F44] rounded-[60px] focus:outline-none focus:ring-orange-700 focus:ring-2 transition-all duration-200 mt-10 " />
                        <input type="email" placeholder="ادرس ایمیل" className="pr-7 px-3 py-8 text-xl xl:text-2xl max-h-[25px] w-[261px] md:w-[180px] xl:w-[449px] placeholder-[#8D521580]/60 dark:placeholder-[#8D5215] border-2 border-[#ED8F44] rounded-[60px] focus:outline-none focus:ring-orange-700 focus:ring-2 transition-all duration-200 " />
                        <input type="text" placeholder="پیام ...." className="pr-7 px-3 py-8 text-xl xl:text-2xl h-[250px] w-[261px] md:w-[180px] xl:w-[449px] placeholder-[#8D521580]/60 dark:placeholder-[#8D5215] border-2 border-[#ED8F44] rounded-[30px] focus:outline-none focus:ring-orange-700 focus:ring-2 transition-all duration-200  " />
